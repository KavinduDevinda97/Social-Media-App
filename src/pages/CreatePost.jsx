      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="max-w-xl bg-white p-4 sm:pb-3 rounded-xl shadow-md space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h2 className="text-slate-900 font-bold">{user.full_name}</h2>
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-300">
            ...
            <input type="file" id="images" hidden multiple accept="image/*" className="hidden" onChange={(e) => setImages([...images, ...e.target.files])} />

            <button disabled={loading} onClick={()=> toast.promise(handleSubmit(), {
              loading: 'Posting...',
              success: <p>Post created!</p>,
              error: <p>Error creating post</p>
            })} className="text-sm bg-gradient-to-r from-teal-500 to-purple-600 hover:from-teal-600 hover:to-purple-500 active:scale-9 transition text-white font-medium px-8 py-2 rounded-md cursor-pointer">Public Post</button>
          </div>
