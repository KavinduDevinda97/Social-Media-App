      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Manage your connections and stay in touch with your network.
          </p>
        </div>
        {/* Connections List */}
        ...
        <div className="mb-8 flex flex-wrap gap-6">
          {dataArray.map((item, index) => (
            <div
              key={index}
              className="flex flex-col items-center justify-center gap-1 border h-20 w-40  border-gray-200 rounded-md bg-teal-50 shadow   "
            >
            ...
            <button
              ...
              className={`cursor-pointer flex items-center px-3 py-1 text-sm rounded-md transition-colors ${
                currentTab === tab.label
                  ...
                  : "text-gray-500 hover:bg-text-black"
              }`}
            >
            ...
            .value.map((user) => (
              ...
              >
                ...
                <div className="flex-1 ">
                  ...
                  <p className="text-slate-600">{user.bio.slice(0, 50)}....</p>

                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    {
                      <button
                        onClick={() => navigate(`/profile/${user._id}`)}
                        className="w-full p-2 text-sm rounded bg-gradient-to-r from-teal-500 to-purple-600 hover:from-teal-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer"
                      >
                        View Profile
                      </button>
                    }
