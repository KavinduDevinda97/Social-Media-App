  ...
  return (
    ...
    >
      ...
      <div className="flex mt-4 gap-2 ">
        {/* button-follow */}
        <button onClick={handleFollow} disabled={currentUser?.following.includes(user._id)} className="w-full py-2 rounded-md flex justify-center items-center gap-2 bg-gradient-to-r from-teal-500 to-violet-600 hover:from-indigo-600 hovver:to-purple-700 active:scale-95 trannsition text-white cursor-pointer">
